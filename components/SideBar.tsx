...
const SideBar = () => {
  return (
    <div className='bg-white p-12 flex flex-col gap-14 h-screen w-fit text-4xl text-gray-400 font-medium'>
        <Link className="active:text-blue-500" href="/">Dashboard</Link>
        <Link className="active:text-blue-500" href="/inventory">Inventory</Link>
        <Link className="active:text-blue-500" href="/users">Users</Link>
        <Link className="active:text-blue-500" href="/">Orders</Link>
        <Link className="active:text-blue-500" href="/">Payments</Link>
